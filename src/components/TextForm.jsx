...
const handleSpeakClick= () =>{
    if (!isSpeaking) {
        ...
        setIsSpeaking(true);
        props.showAlert("you are listening the texts" , "success")
      } else {
        window.speechSynthesis.cancel();
        setIsSpeaking(false);
        props.showAlert("Text listenind stopped" , "success")
      }
  ...
  return (
    <>
      <div className="container" style={{color: props.mode==='dark'? 'white':'#042743'}}>
        ...
        <button className="btn btn-primary mx-1 my-1" onClick={handleSpeakClick}>{isSpeaking ? 'Stop Voice' : 'Start Voice'}</button>
